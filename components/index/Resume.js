...
const Resume = () => {
    return (
        <div className="container">
            ...
            Hi! I'm Kevin Tsai. I'm a software engineer and web developer. 😊</h3>
            <section className="about-me">
                <h4>About me</h4>
                <p>Hi! I'm Kevin Tsai. Your friendly software engineer and web developer. I enjoy building content on the web and solving problems through code. 
            ...
            <section className="toolkit">
                <h4>Toolkit</h4>
                <ul>
                    <li className="tool"><strong>HTML, CSS, JavaScript</strong></li>
                    <li className="tool">React, Node, Express, jQuery, Rest, API, MongoDB</li>
